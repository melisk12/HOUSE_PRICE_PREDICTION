...
from PROJELER.HOUSE_PRICE_PREDICTION import data_reading_EDA as de
from PROJELER.HOUSE_PRICE_PREDICTION import feature_engineering as fe
from PROJELER.HOUSE_PRICE_PREDICTION import model as md
from PROJELER.HOUSE_PRICE_PREDICTION import variable_evaluations as ve
import numpy as np
import pandas as pd
...
df = de.dataframe_reading("PROJELER/HOUSE_PRICE_PREDICTION/dataset/train.csv")
...
test_df = de.dataframe_reading("PROJELER/HOUSE_PRICE_PREDICTION/dataset/train.csv")
